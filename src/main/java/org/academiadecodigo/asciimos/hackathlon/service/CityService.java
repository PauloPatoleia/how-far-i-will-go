...
public class CityService {
    ...
    public CityService() {
        ...
        cityList.add(new City("Fundão", 0, 0, 13, 5, 12)
        ...
        cityList.add(new City("Covilhã", 24, 18, 12, 20, 16)
        ...
        cityList.add(new City("Porto", 244, 200, 13, 45, 22)
        ...
        cityList.add(new City("Madrid", 285, 396, 11,60, 24)
        ...
        cityList.add(new City("Barcelona", 660, 1013, 13, 60, 26)
        ...
        cityList.add(new City("Paris", 1172, 1525, 11, 120, 26)
        ...
        cityList.add(new City("Amsterdam", 1440, 2043, 8, 80, 21)
        ...
        cityList.add(new City("Berlin", 1680, 2515, 9, 40, 25)
        ...
        cityList.add(new City("London", 1440, 1920, 11,70, 28)
